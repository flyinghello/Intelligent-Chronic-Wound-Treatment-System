...
public:
    ...
    bool setdata(QStringList datastringlist, QPixmap image);
    bool setdata(QStringList datastringlist);
    bool setdata(QPixmap image);
    bool setheaderlist(QStringList header);
private:
    QStringList _header;
