...
// setIsCentralStackedWidgetTransparent(true);
    ...
    setWindowTitle(QString::fromLocal8Bit("微电智疗"));
    // setIsStayTop(true);
...
void Appshow::initContent()
{
    ...
    QString testKey_1;
    QString testKey_2;
    addPageNode(QString::fromLocal8Bit("病人查询  "), _patientshow, ElaIconType::House);
    addPageNode(QString::fromLocal8Bit("病人详情  "), _patienttabview, ElaIconType::House);
    addPageNode(QString::fromLocal8Bit("添加数据库数据 "), _addfdc, ElaIconType::House);
    addPageNode(QString::fromLocal8Bit("数据库页表  "), _tablefdc, ElaIconType::House);
