...
struct qt_meta_stringdata_CLASST_TableViewENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASST_TableViewENDCLASS = QtMocHelpers::stringData(
    "T_TableView",
    "",
    "QWidget*",
    "parent"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASST_TableViewENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASST_TableViewENDCLASS_t qt_meta_stringdata_CLASST_TableViewENDCLASS = {
    {
        QT_MOC_LITERAL(0, 11),  // "T_TableView"
        QT_MOC_LITERAL(12, 0),  // ""
        QT_MOC_LITERAL(13, 8),  // "QWidget*"
...
Q_CONSTINIT static const uint qt_meta_data_CLASST_TableViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject T_TableView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASST_TableViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASST_TableViewENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASST_TableViewENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<T_TableView, std::true_type>,
        // constructor 'T_TableView'
...
void *T_TableView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASST_TableViewENDCLASS.stringdata0))
