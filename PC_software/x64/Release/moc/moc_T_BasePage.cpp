...
static constexpr auto qt_meta_stringdata_CLASST_BasePageENDCLASS = QtMocHelpers::stringData(
    "T_BasePage"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASST_BasePageENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASST_BasePageENDCLASS_t qt_meta_stringdata_CLASST_BasePageENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10)   // "T_BasePage"
    },
    "T_BasePage"
};
