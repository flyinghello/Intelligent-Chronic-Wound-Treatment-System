...
static constexpr auto qt_meta_stringdata_CLASST_BaseComponentsENDCLASS = QtMocHelpers::stringData(
    "T_BaseComponents",
    "",
    "QWidget*",
    "parent"
...
void T_BaseComponents::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        switch (_id) {
        case 0: { T_BaseComponents *_r = new T_BaseComponents((*reinterpret_cast< std::add_pointer_t<QWidget*>>(_a[1])));
